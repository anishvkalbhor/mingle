        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="w-full lg:w-[45%] flex-shrink-0">
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 w-10 h-10 bg-gradient-to-br from-pink-100 to-purple-100 rounded-full translate-y-4 -translate-x-4 opacity-50"></div>
